...
def weather_view(frame):
    print("weather")
    lbl = Label(frame, text="El tiempo", font=("Arial Bold", 50))
    lbl.grid(column=0, row=0)
    lbl2 = Label(frame, text="22ºC", font=("Arial Bold", 50))
    lbl2.grid(column=1, row=0)

    lbl3 = Label(frame, text="PONTEVEDRA", font=("Arial Bold", 50))
    lbl3.grid(column=0, row=1)
    icon_weather = get_icon()
    img_wea = Label(frame, image=icon_weather)
